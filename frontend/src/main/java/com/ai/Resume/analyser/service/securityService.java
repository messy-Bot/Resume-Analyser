...
public class securityService {
    ...
    public ResponseEntity<?> register(userRegister reg) {
        ...
        if (!verify.getVerifyOtp()
                .equals(reg.getVerifyotp())) {
        ...
        if (!usersTableRepository
            ...
            otpVerifyRepository.deleteById(
                    reg.getEmail()
            );
    ...
    public ResponseEntity<?> verifyEmail(
        ...
        if (!usersTableRepository
                .existsById(verifyEmail.getEmail())) {
            ...
            try {
                ...
                mailservice.sentVerifyOtp(
                        verifyEmail.getUsername(),
                        verifyEmail.getEmail(),
                        otp
                );
